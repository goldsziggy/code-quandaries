...
Source: https://www.codewars.com/kata/573d498eb90ccf20a000002a */
 ...
 */
function decode (num) {
  const cipher = { 0: 5, 1: 9, 2: 8, 3: 7, 4: 6, 5: 0, 6: 4, 7: 3, 8: 2, 9: 1 }
  return num
    .split('')
    .map((x) => cipher[parseInt(x)])
    .join('')
}
...
describe('All Balanced Parens code-test', () => {
  it('should handle case 1', () => {
    ...
    for (const code in phoneNumbers) {
      expect(decode(code)).toEqual(phoneNumbers[code])
    }
  })
})
