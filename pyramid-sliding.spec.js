/**
 Challenge #328 [Intermediate] Pyramid sliding
Description
 ...
 * @param {Array} pyramid
 */
const pyramidSlide = (length, pyramid) => {
  // bottom up, starting from the second to last keep adding the minimum till we get to the top
...
describe('A Captial Challenge code-test', () => {
  it('should handle base case', () => {
    expect(pyramidSlide(4, [[3], [7, 4], [2, 4, 6], [8, 5, 9, 3]])).toBe(16)
  })
})
