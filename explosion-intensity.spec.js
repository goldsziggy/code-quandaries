...
source:  https://edabit.com/challenge/XnZAcvr4tCD9ppyrN
 */
...
function boomIntensity(num) {
  ...
  const o = 'o'.repeat(num)
  const word = `B${o}m${num % 2 === 0 ? '!' : ''}`
  return num % 5 === 0 ? word.toUpperCase() : word
}

describe('A traafficLights', () => {
  it('should work for case 1', () => {
    expect(boomIntensity(4)).toEqual('Boooom!')
  })
  it('should work for case 2', () => {
    expect(boomIntensity(1)).toEqual('boom')
  })
  it('should work for case 3', () => {
    expect(boomIntensity(5)).toEqual('BOOOOOM')
  })
  it('should work for case 4', () => {
    expect(boomIntensity(10)).toEqual('BOOOOOOOOOOM!')
  })
})
